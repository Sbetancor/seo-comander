<template>
    <div class="mb-5">
        <!-- Modal -->
        <TransitionRoot appear :show="isCreateProjectModalOpen" as="template">
            <Dialog as="div" @close="modalStore.closeModal('createProjectModal')" class="relative z-50">
                <TransitionChild
                    as="template"
                        ...
                        >
                            <DialogPanel class="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                <button
                                    ...
                                    @click="modalStore.closeModal('createProjectModal')"
                                >
                                    <svg
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="flex justify-end items-center mt-8">
                                        <button type="button" @click="modalStore.closeModal('createProjectModal')" class="btn btn-outline-danger">
                                            Discard
                                        </button>
                                        <button type="button" @click="modalStore.closeModal('createProjectModal')" class="btn btn-primary ltr:ml-4 rtl:mr-4">
                                            Save
                                        </button>
                                    </div>
                                </div>
...
<script setup>
    ...
    const isCreateProjectModalOpen = computed(() => modalStore.isModalOpen('createProjectModal'));
</script>
