<template>
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <router-link to="/profile" class="text-primary hover:underline">Perfil</router-link>
            </li>
        </ul>
        <div class="pt-5">
            <div class="flex items-center justify-between mb-5">
                ...
                <div class="flex justify-end">
                    <button @click="modalStore.openModal('inviteModal')" type="button" class="btn btn-primary">Invitar Cliente</button></div>
...
<script lang="ts" setup>
    ...
    import inviteClient from '@/components/modals/inviteClient.vue';
